...
In beyond root I demonstrate the risk of excessive permisions by dumping the local registry hives giving us access to the `Domain Administrator` account using a `pass the hash attack`.
